...
OUT_JSON = DATA / "fury_trinket_recommendations.json"
...
def main() -> None:
    ...
    output = {
        "_meta": {
            ...
            "notes": [
                ...
                "장신구 목록은 하드코딩 없이 분노 상위권 장비에 실제로 나온 것만 집계합니다.",
    ...
    try:
        ...
        record(
            action="analyze_fury_trinket_recommendations",
