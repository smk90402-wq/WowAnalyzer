...
SPEC_CONFIG = {
    ...
    ("Warrior", "Fury"): {
        # ID 전부 2026-07-11 실측 확정 (tmp_mine_fury_cd/proc — 특성ID와 실캐스트ID가 다름 주의:
        # 칼날폭풍은 특성 227847이 아니라 446035 로 시전됨)
        "cooldowns": {1719: "무모한 희생", 385059: "오딘의 격노",
                      107574: "투신", 446035: "칼날폭풍"},
        "track_buffs": {184362: "격노", 52437: "급살"},
        # 산왕 키스톤(우레 작렬 노드) = 광역 빌드 마커. 학살자=단일.
        "build_node": 94785, "build_label": ("산왕(광)", "학살자(단일)"),
    },
    ("Warrior", "Arms"): {
        "cooldowns": {107574: "투신", 167105: "거인의 강타",
                      446035: "칼날폭풍", 436358: "쇄파", 228920: "쇠날발톱"},
        "track_buffs": {52437: "급살", 1269391: "전쟁의 지배자"},
        # 거신 키스톤(해골전율자 노드) = 광역 빌드 마커. 학살자=단일.
        "build_node": 94789, "build_label": ("거신(광)", "학살자(단일)"),
    },
}
