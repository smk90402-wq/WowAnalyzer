...
PUG_WELCOME: dict[tuple[str, str], tuple[int, str]] = {
    ...
    ("Hunter", "Beast Mastery"): (5, "구인 수요 1위 — 사냥꾼 30/138 공대(22%)가 찾음. 원딜·러스트·유연성. 본캐"),
    ("Hunter", "Marksmanship"): (5, "사냥꾼 구인 30 공유 — 원딜 사냥꾼 자리 흔함 (원딜 34 vs 근딜 12)"),
    ("Evoker", "Augmentation"): (5, "구인 24(2위) + 수요/공급 16.5 — 가장 많이 찾으면서 희소, 버퍼 1자리 고정 수요"),
    ...
    ("Evoker", "Devastation"): (4, "★구인 7 + 공급 최소 211 → 수요/공급 33 전체 1위 = '구인 어려운 직업'. 희소해 콕집어 환영 (로스터 TO는 놓침)"),
