...
- 칠흑의 힘 Ebon Might = **395152** (icon spell_sarkareth)
...
| KPI | 측정 | 빨강/노랑 |
|---|---|---|
| 칠흑 유지율% | 395152 cast + 연장모델(불숨/격변+2,분출+1) | 1등 또는 목표 미달 |
...
**측정 불가 → 교육용 주석(2026-06-13 결정):** 칠흑 크리값 보호·버프 대상 최적성·위상분할 악용은 현재 캐시로 자동판정 불가 → 빨강 아님. 대신 패널/툴팁에 '알아야 할 점' 개념 설명(info)으로 노출하고 넘어감.
...
- ✅ **칠흑의 힘 395152가 cast로 찍힘**(8회) → 유지율 재구성 전제 성립.
- ✅ **보너스**: buffs 이벤트에 칠흑 395152(76건)·예지 410089(366건) 존재 → **버프 구간 union으로 실측 유지율·예지 적용횟수 직접 계산 가능**(캐스트 모델보다 정확 → 이 방식 채택).
- 실측 cast ID 핀: 칠흑 cast=395152 / 예지 cast=409311·buff=410089 / 영겁 cast=**442204** / 불숨=357208 / 격변=396286 / 분출 cast=395160·buff=438588 / 살불=361469(+361509) / 전세역전=370553 / 시간도약=404977 / 하늘빛일격=362969.
