"""무기 전사 보스별 스탯 우선순위 생성기.

신화 top100 랭킹 스냅샷 + player_fight 스탯 캐시를 읽어
data/arms_stat_recommendations.json 을 만든다 (스탯 탭 소비용).
...
Arms 전용 개념은 없고, 1~20등 개별 스탯 + 21~100등 평균과
...
OUT_JSON = DATA_DIR / "arms_stat_recommendations.json"
...
def main() -> None:
    ...
    try:
        ...
        record(
            action="analyze_arms_stat_recommendations",
